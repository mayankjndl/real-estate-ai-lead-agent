...
export default function Footer() {
  return (
    <footer className="bg-zinc-950 border-t border-zinc-900 py-12 px-6 mt-auto transition-colors duration-300">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="col-span-1 md:col-span-2">
          <Link href="/" className="flex items-center gap-3 mb-4">
            ...
            <span className="font-semibold tracking-tight text-white">Revenue OS</span>
          </Link>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-zinc-400">
            ...
            <li><Link href="/demo" className="hover:text-emerald-400 transition-colors">Book a Demo</Link></li>
          </ul>
        </div>
      ...
      <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-zinc-900 flex flex-col md:flex-row items-center justify-between gap-4">
