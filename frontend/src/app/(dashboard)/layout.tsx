...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  return (
    <ThemeProvider attribute="class" defaultTheme="dark" storageKey="dashboard-theme" enableSystem={false}>
      <div className="min-h-screen bg-slate-50 dark:bg-zinc-950 text-slate-900 dark:text-white flex flex-col md:flex-row transition-colors duration-300">
        <Suspense fallback={<div className="w-64 border-r border-slate-200 dark:border-zinc-900 bg-white dark:bg-zinc-950" />}>
          <Sidebar />
        </Suspense>
