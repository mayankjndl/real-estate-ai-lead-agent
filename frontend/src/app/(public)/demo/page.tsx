...
export default function DemoPage() {
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-zinc-950 text-slate-900 dark:text-white selection:bg-emerald-500/30 pb-24 font-sans relative overflow-hidden">
      ...
      <header className="pt-24 pb-12 px-6 max-w-7xl mx-auto text-center animate-in fade-in slide-in-from-bottom-4 duration-1000">
        ...
        <p className="text-lg text-slate-600 dark:text-zinc-400 max-w-2xl mx-auto font-light mb-8">
      ...
      <main className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto items-start animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-300">
          ...
          {/* Real Calendly Embed */}
          <div className="bg-white/80 dark:bg-white/5 border border-slate-200 dark:border-zinc-800 p-2 rounded-3xl shadow-lg dark:shadow-xl backdrop-blur-md relative overflow-hidden">
            <div 
